...
| `document-automation/` | Document Automation (formerly Litigation Tools; `litigation-tools/` now only redirects) — the firm's documents filled from what changes and exported as Word: the Attorney Appointment (ใบแต่งทนายความ, form ๙), the Power of Attorney to Sue (หนังสือมอบอำนาจให้ฟ้องคดี), and the Certified ID Copy (สำเนาบัตรประชาชน รับรองสำเนาถูกต้อง) as an A4 Word .docx; each build lives in `_build/` |
